	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE cellSpacing="1" cellPadding="1" width="98%" align="center" bgColor="#6699ff" border="0">
				<TR>
					<TD align="center" height="20"><font style="FONT-SIZE: 12px; COLOR: #ffffff"><b>创建角色</b></font></TD>
				</TR>
				<TR>
							...
							<TR>
								...
								<TD style="FONT-SIZE: 12px" align="left" height="7">
									<table>
										...
										<TR>
											<TD style="FONT-SIZE: 12px" align="center" width="80" height="7"></TD>
											<TD style="FONT-SIZE: 12px" align="right" height="7"><input type="button" onclick="add_role();" value="确 定" class="textinput"></TD>
										</TR>
									</table>
								</TD>
							</TR>
