//时间.js
			function addYear()
			{
				var objDate=document.getElementsByName("date");
			...
			function checkDate()
			{
				var year=document.getElementsByName("date")[0].value;
				//alert(year);
				//alert(document.getElementById("year"));
				var month=document.getElementsByName("date")[1].value;
				//alert(month);
